...
include_once 'core/lekhpalAppReportView.core.php';
?>
<!doctype html>
            ...
            <div class="full-column db-cont-wrap right">
                ...
                <div class="filter-div">
                    ...
                    <div class="tbl-data right posrel" title="Export Excel">
                        ...
                        <a style="cursor:pointer;" class="export_excel_lekhpal_app_report_view" id="all">
                                ...
                                foreach ($villageInfo as $key => $value) {
                                    ...
                                    <div class="rowDiv <?php echo $color; ?>">
                                        <div class="cellDivCenter col1">
                                            <a style="cursor: pointer;" class="view_lekhpal_app_data" id="<?php echo encryptIt($value['VillageCode']); ?>"><?php echo $value['VillageName']; ?></a>
                                        </div>
