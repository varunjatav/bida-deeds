...
include_once 'core/lekhpalReport.core.php';
?>
<!doctype html>
            ...
            <div class="full-column db-cont-wrap right">
                ...
                <div class="filter-div">
                    <div style="" class="left">
                        <div class="tabl3">
                            <a href="lekhpalreport" class="active">
                                <p>E-Basta Wise</p>
                            </a>
                            <a href="lekhpalappreport">
                                <p>Mobile-App Wise</p>
                            </a>
                            <div class="clr"></div>
                        </div>
                    ...
                    <div class="tbl-data right posrel" title="Export Excel">
                        ...
                        <a style="cursor:pointer;" class="export_excel_lekhpal_report" id="all">
                ...
                <div class="scrl-tblwrap">
                    <div class="containerDiv">
                        ...
                        <div class="rowDivHeader">
                            ...
                            <div class="repoCellDivHeaderCenter">
                                <p>Uploaded Khatauni</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Uploaded Khatauni Area</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Remaining Khatauni</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Remaining Khatauni Area</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Uploaded Kabza</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Uploaded Kabza Area</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Remaining Kabza</p>
                            </div>
                            <div class="repoCellDivHeaderCenter">
                                <p>Remaining Kabza Area</p>
                            </div>
                        </div>
                        <div id="main-body" style="display: contents;">
                            <div id="paginate-body" style="display: contents;">
                                ...
                                foreach ($lekhpalInfo as $key => $value) {
                                    ...
                                    $khatauni_uploaded = $khatauni_count_array[$value['UserID']] ? $khatauni_count_array[$value['UserID']] : 0;
                                    $kabza_uploaded = $kabza_count_array[$value['UserID']] ? $kabza_count_array[$value['UserID']] : 0;
                                    ...
                                    $uploaded_khatauni_area = $uploaded_khatauni_area_array[$value['UserID']]['AnshRakba'] ? $uploaded_khatauni_area_array[$value['UserID']]['AnshRakba'] : 0;
                                    $uploaded_kabza_area = $uploaded_kabza_area_array[$value['UserID']]['AnshRakba'] ? $uploaded_kabza_area_array[$value['UserID']]['AnshRakba'] : 0;
                                    ...
                                    $col11_total += $khatauni_uploaded;
                                    $col12_total += $uploaded_khatauni_area;
                                    $col13_total += $total_kashtkar - $khatauni_uploaded;
                                    $col14_total += $remaining_khatauni_area;
                                    $col15_total += $kabza_uploaded;
                                    $col16_total += $uploaded_kabza_area;
                                    $col17_total += $total_kashtkar - $kabza_uploaded;
                                    $col18_total += $remaining_kabza_area;
                                    ?>
                                    <div class="rowDiv <?php echo $color; ?>">
                                        <div class="cellDivCenter col1">
                                            <a href="lekhpalreportview?id=<?php echo encryptIt($value['UserID']); ?>"><?php echo $value['Name']; ?></a>
                                        </div>
                                        ...
                                        <div class="cellDivCenter col11" name="<?php echo $khatauni_uploaded; ?>">
                                            <?php echo $khatauni_uploaded; ?>
                                        </div>
                                        <div class="cellDivCenter col12" name="<?php echo $uploaded_khatauni_area; ?>">
                                            <?php echo $uploaded_khatauni_area; ?>
                                        </div>
                                        <div class="cellDivCenter col13" name="<?php echo ($total_kashtkar - $khatauni_uploaded); ?>">
                                            <?php echo ($total_kashtkar - $khatauni_uploaded); ?>
                                        </div>
                                        <div class="cellDivCenter col14" name="<?php echo $remaining_khatauni_area; ?>">
                                            <?php echo $remaining_khatauni_area; ?>
                                        </div>
                                        <div class="cellDivCenter col15" name="<?php echo $kabza_uploaded; ?>">
                                            <?php echo $kabza_uploaded; ?>
                                        </div>
                                        <div class="cellDivCenter col16" name="<?php echo $uploaded_kabza_area; ?>">
                                            <?php echo $uploaded_kabza_area; ?>
                                        </div>
                                        <div class="cellDivCenter col17" name="<?php echo ($total_kashtkar - $kabza_uploaded); ?>">
                                            <?php echo ($total_kashtkar - $kabza_uploaded); ?>
                                        </div>
                                        <div class="cellDivCenter col18" name="<?php echo $remaining_kabza_area; ?>">
                                            <?php echo $remaining_kabza_area; ?>
                                        </div>
                                    </div>
                                    <?php
                                }
