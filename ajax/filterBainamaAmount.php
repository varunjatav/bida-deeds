...
<input type="hidden" name="total_bainama_amount" id="total_bainama_amount" value="<?php echo $bainama_total_amount; ?>" autocomplete="off">
<input type="hidden" name="payment_total_amount" id="payment_total_amount" value="<?php echo $payment_total_amount; ?>" autocomplete="off">
<input type="hidden" name="amount_left" id="amount_left" value="<?php echo ($bainama_total_amount - $payment_total_amount); ?>" autocomplete="off">
<input type="hidden" name="total_bainama_area" id="total_bainama_area" value="<?php echo $total_bainama_area; ?>" autocomplete="off">
<input type="hidden" name="vilekh_without_payment" id="vilekh_without_payment" value="<?php echo $vilekh_without_payment; ?>" autocomplete="off">
<input type="hidden" name="total_parisampatti_amount" id="total_parisampatti_amount" value="<?php echo $total_parisampatti_amount; ?>" autocomplete="off">