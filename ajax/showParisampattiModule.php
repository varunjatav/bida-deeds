...
include_once '../core/showFilterparisampatti.core.php'
?>
                ...
                <form id="ffrm">
                    <div class="filter-box">
                        <div class="filter-tabber left">
                            ...
                            <a style="cursor:pointer;" id="2" class="ftab">Village Name</a>
                            <a style="cursor:pointer;" id="3" class="ftab">Different Amount</a> 
                        </div>

                        <div class="left filter-taboptions">
                            <div class="tab1" id="stab_1" style="border: none;">
                                <div class="filter-choice">
                                    <div class="frm-lbl-actv" style="margin-bottom: 5px;">Select Department:</div>
                                    <div class="select dev_req_msg left rmarg">
                                        <select name="department_id" class="apply_filter_change">
                                            <option value="">Select Department</option>
                                            <?php foreach ($deptInfo as $dKey => $dValue) { ?>
                                                <option value="<?php echo $dValue['ID']; ?>"><?php echo $dValue['DepartmentName']; ?></option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="tab1" id="stab_3" style="display:none;">
                                <label>
                                    <div class="filter-choice">
                                        <span class="fltr-radio left">
                                            <input type="checkbox" name="diff_amt[]" value="0"
                                                   class="apply_filter_change chk">
                                        </span>
                                ...
                                <label>
                                    <div class="filter-choice">
                                        <span class="fltr-radio left">
                                            <input type="checkbox" name="diff_amt[]" value="1"
                                                   class="apply_filter_change chk">
                                        </span>
                                        <span class="fltr-name text-wrapping left">
                                            Different Amount
