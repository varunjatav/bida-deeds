                ...
                <form id="ffrm">
                    <div class="filter-box">
                        <div class="filter-tabber left">
                            ...
                            <a style="cursor:pointer;" id="4" class="ftab">UID No</a>
                        </div>
                        ...
                        <div class="left filter-taboptions">
                            ...
                            <div class="tab1" id="stab_4" style="display:none; border: none;">
                                <div class="frm-lbl-actv">UID No:</div>
                                <input type="text" name="uid_no" class="frm-txtbox dept-frm-input apply_filter_keyup" maxlenth="20" placeholder="Enter uid number" autocomplete="off">
                            </div>
                        </div>
                        <div class="clr"></div>
                    </div>
