                ...
                <form id="ffrm">
                    <div class="filter-box">
                        <div class="filter-tabber left">
                            ...
                            <a style="cursor:pointer;" id="4" class="ftab">Kashtkar Name</a>
                            <a style="cursor:pointer;" id="5" class="ftab">Mobile Number</a>
                        </div>
                        ...
                        <div class="left filter-taboptions">
                            ...
                            <div class="tab1" id="stab_4" style="display:none; border: none;">
                                ...
                                <input type="text" name="owner_name" class="frm-txtbox dept-frm-input apply_filter_keyup" maxlenth="100" placeholder="Enter kashtkar name" autocomplete="off">
                            </div>
                            <div class="tab1" id="stab_5" style="display:none; border: none;">
                                <div class="frm-lbl-actv">Mobile Number:</div>
                                <input type="text" name="mobile" class="frm-txtbox dept-frm-input numeric apply_filter_keyup" maxlenth="12" placeholder="Enter kashtkar mobile" autocomplete="off">
                            </div>
                        </div>
                        <div class="clr"></div>
                    </div>
