                ...
                <form id="ffrm">
                    <div class="filter-box">
                        <div class="filter-tabber left">
                            ...
                            <a style="cursor:pointer;" id="2" class="ftab"><?php echo $landmaster_filter_popup['gata_wise']; ?></a>
                            <a style="cursor:pointer;" id="3" class="ftab"><?php echo $landmaster_filter_popup['khata_no']; ?></a>
                            <a style="cursor:pointer;" id="4" class="ftab"><?php echo $landmaster_filter_popup['shreni']; ?></a>
                            <a style="cursor:pointer;" id="5" class="ftab"><?php echo $landmaster_filter_popup['board_approved']; ?></a>
                            <a style="cursor:pointer;" id="6" class="ftab"><?php echo $master_data_list['validate_status']; ?></a>
                        </div>
                        ...
                        <div class="left filter-taboptions">
                            ...
                            <div class="tab1" id="stab_2" style="display:none; border: none;">
                                <div class="filter-choice">
                                    <div class="frm-lbl-actv" style="margin-bottom: 5px;"><?php echo $landmaster_filter_popup['select_village']; ?>:</div>
                                    <div class="select dev_req_msg left rmarg">
                                        <select id="village_code" name="select_village_with_gata">
                                            <option value=""><?php echo $landmaster_filter_popup['select_village']; ?></option>
                                            <?php foreach ($villageInfo as $sKey => $sValue) { ?>
                                                <option value="<?php echo $sValue['VillageCode']; ?>"><?php echo $sValue['VillageName']; ?></option>
                                            <?php } ?>
                                ...
                                <div class="filter-choice">
                                    <div class="frm-lbl-actv" style="margin-bottom: 5px;"><?php echo $landmaster_filter_popup['select_gata']; ?>:</div>
                                    <div class="select dev_req_msg left rmarg">
                                        <select name="village_gata" id="village_gata" class="apply_filter_change">
                                            <option value=""><?php echo $landmaster_filter_popup['select_gata']; ?></option>
                                        </select>
                                        <div class="select__arrow"></div>
                                    </div>
                                </div>
                            ...
                            <div class="tab1" id="stab_4" style="display:none; border: none;">
                                ...
                                <input type="text" name="shreni" class="frm-txtbox dept-frm-input apply_filter_keyup" maxlenth="25" placeholder="<?php echo $landmaster_filter_popup['shreni']; ?>" autocomplete="off">
                            </div>
                            <div class="tab1" id="stab_5" style="display:none; border: none;">
                                <div class="frm-lbl-actv"><?php echo $landmaster_filter_popup['board_approved']; ?>:</div>
                                <div class="select dev_req_msg left rmarg">
                                    <select name="board_approved" class="apply_filter_change">
                                        <option value=""><?php echo $landmaster_filter_popup['select']; ?></option>
                                        <option value="YES"><?php echo $landmaster_filter_popup['yes']; ?></option>
                                        <option value="NO"><?php echo $landmaster_filter_popup['no']; ?></option>
                                    </select>
                                    <div class="select__arrow"></div>
                                </div>
                            </div>
                            <div class="tab1" id="stab_6" style="display:none; border: none;">
                                <div class="frm-lbl-actv"><?php echo $master_data_list['validate_status']; ?>:</div>
                                <div class="select dev_req_msg left rmarg">
                                    <select name="validate_status" class="apply_filter_change">
                                        <option value=""><?php echo $landmaster_filter_popup['select']; ?></option>
                                        <option value="0"><?php echo $landmaster_filter_popup['not_valid_status']; ?></option>
                                        <option value="1"><?php echo $landmaster_filter_popup['valid_status']; ?></option>
                                    </select>
                                    <div class="select__arrow"></div>
                                </div>
                            </div>
