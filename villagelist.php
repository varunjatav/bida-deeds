...
<!--                <div class="master-creation right">
                    ...
                    <a style="cursor:pointer;" class="add_new_data">
                        ...
                        <span class="crtxt">Add New Data</span>
                        <div class="clr"></div>
                    </a>
                </div>-->
                <div class="clr"></div>
                    ...
                    <div class="containerDiv">
                        <div class="rowDivHeader">
                            <div class="cellDivHeader">
                                <p><?php echo $village_data_list['sr']; ?></p><a style="cursor:pointer;" onclick="sort_name(1, 'numeric');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p><?php echo $village_data_list['village_code']; ?></p><a style="cursor:pointer;" onclick="sort_name(2, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p><?php echo $village_data_list['village_code']; ?></p><a style="cursor:pointer;" onclick="sort_name(3, 'numeric');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p><?php echo $village_data_list['village_validate_status']; ?></p><a style="cursor:pointer;" onclick="sort_name(4, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p><?php echo $village_data_list['action']; ?></p><a style="cursor:pointer;" onclick="sort_name(5, '');"></a>
                            </div>
                        </div>
                                ...
                                <div class="pagination">
                                    <div class="left rsltpp">
                                        ...
                                        <div class="rsl-counter left posrel">
                                            <a style="cursor:pointer;" class="perPage">25</a>
                                    ...
                                    <input type="hidden" id="pagelimit" autocomplete="off" value="25">
...
<script src="scripts/villagedatalist.js"></script>
<script>
                                    $(document).ready(function () {
                                        $('.full-column').on('click', '.paginate', function () {
                                            loadMoreVillageData(parseInt($(this).text()) - 1);
                                        });
                                        $('.full-column').on('click', '.paginate_next', function () {
                                            loadMoreVillageData(parseInt($('.current').attr('id')));
                                        });
                                        $('.full-column').on('click', '.paginate_prev', function () {
                                            loadMoreVillageData(parseInt($('.current').attr('id')) - 2);
                                        });
                                        $('.full-column').on('click', '.paginate_last', function () {
                                            loadMoreVillageData(parseInt($('.paginate:last').text()) - 1);
                                        });
                                    });
