    ...
    <div class="popup-wrap pp-large-x">
        <form id="confrm" autocomplete="off">
            <div class="popup-header" style="cursor: move;">
                <span class="popup-title text-wrapping left">Report Summary</span>
            ...
            <div class="popup-body pp-large-y">
                <div class="filter-div">
                    <div class="left" style="font-size: 16px; font-weight: 600; line-height: 34px;"><?php echo $title; ?></div>
                    ...
                    <div class="tbl-data right posrel" title="Export Excel">
                        ...
                        <a style="cursor:pointer;" class="export_report_data_excel" id="<?php echo $report_data; ?>">
                            <img src="img/excel.svg" height="22px">
                        </a>
                    </div>
                    <div class="ebasta_select dev_req_msg right">
                        <select id="repo_filter_village_code">
            ...
            <input type="hidden" id="report_data" value="<?php echo $report_data; ?>" autocomplete="off">
            <div class="popup-actionwrap posrel">
                <div class="left lmarg" style="font-size: 14px; line-height: 40px; font-weight: 500; color: darkgreen;">
                    <div id="additional_details" style="display: flex; gap: 20px;"></div>
                </div>
                <div class="posabsolut act_btn_ovrly"></div>
