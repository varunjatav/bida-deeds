    ...
    <div class="popup-wrap pp-large-x">
        <form id="confrm" autocomplete="off">
            <div class="popup-header" style="cursor: move;">
                <span class="popup-title text-wrapping left">Lekhpal App Report</span>
            ...
            <div class="popup-body pp-large-y">
                <div class="filter-div">
                    ...
                    <div class="tbl-data right posrel" title="Export Excel">
                        ...
                        <a style="cursor:pointer;" class="export_lekhpal_app_view_report" id="<?php echo $dashboard_data; ?>">
                        ...
                        <div id="main-body" style="display: contents;">
                            <div id="paginate-body" style="display: contents;">
                                ...
                                while ($row = $sql->fetch()) {
                                    ...
                                    $sahmati_key = array_key_exists(1, $explode_type) ? array_search(1, $explode_type) : '';
                                    $sahmati_document = isset($sahmati_key) ? $explode_attachment[$sahmati_key] : '';
                                    $bainama_key = array_key_exists(2, $explode_type) ? array_search(2, $explode_type) : '';
                                    $bainama_document = isset($bainama_key) ? $explode_attachment[$bainama_key] : '';
                                    ?>
                                    <div class="rowDiv">
                                        ...
                                        <div class="cellDiv col2" style="text-align: center;">
                                            <?php if ($sahmati_document) { ?>
                                                <a class="" title="Download Sahmati" target="_blank" href="download?file=<?php echo base64_encode($sahmati_document); ?>&type=<?php echo base64_encode('lekhpal_ebasta'); ?>">
                                        ...
                                        <div class="cellDiv col2" style="text-align: center;">
                                            <?php if ($bainama_document) { ?>
                                                <a class="" title="Download Bainama" target="_blank" href="download?file=<?php echo base64_encode($bainama_document); ?>&type=<?php echo base64_encode('lekhpal_ebasta'); ?>">
                                                    <div style="position: relative;">
                                                        <img src="img/download_1.svg" height="18px;">
                                                    </div>
                                                </a>
