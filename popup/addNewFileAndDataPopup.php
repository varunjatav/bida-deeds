                            ...
                            <div class="form-field-wrap posrel left">
                                ...
                                <div class="select dev_req_msg left rmarg branch_parent" id="branchDropDown">
                                    ...
                                    <div class="dropdown-content">
                                        ...
                                        <?php foreach ($branch_list_array as $dKey => $dValue) { ?>
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" name="branch[]" value="<?php echo $dValue; ?>" class="fldrequired village-dropdown">
...
<script>
    $(document).ready(function() {
        ...
        function updateDropdownHeader($dropdown) {
            ...
            $dropdown.closest('.branch_parent').find('.branch_data').val(displayText);
        }
        initializeDropdown();
