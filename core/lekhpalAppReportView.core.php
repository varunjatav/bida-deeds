...
$sql = $db->prepare("SELECT T1.VillageCode, ROUND(SUM(T2.Rakba), 4) AS AnshRakba
                        FROM lm_user_village_gata_mapping T1
                        LEFT JOIN lm_lekhpal_ebasta T2 ON T2.VillageCode = T1.VillageCode AND T2.KhataNo = T1.KhataNo AND T2.GataNo = T1.GataNo
...
$sql->bindValue(2, '2');
$sql->bindValue(3, 'YES');
$sql->bindParam(4, $lekhpal_user_id);
$sql->bindValue(5, '1');
$sql->execute();
