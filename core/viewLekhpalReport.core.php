...
$sql = $db->prepare("SELECT T1.GataNo, T3.KhataNo, T3.owner_name, T3.owner_father, T4.Ebasta1, T4.Ebasta2, T4.Ebasta3, T4.Ebasta4
                        ...
                        LEFT JOIN lm_gata_ebasta T4 ON T4.VillageCode = T3.VillageCode AND T4.KhataNo = T3.KhataNo AND T4.GataNo = T3.GataNo AND T4.OwnerNo = T3.OwnerNo
