            ...
            <div class="full-column db-cont-wrap right">
                <div class="column-head">
                    <div class="left pageback" style="display:flex;">
                        ...
                        <div class="col-pagename left">SLAO Reports (<tCount><?php echo $total_count; ?></tCount>)
                        </div>
                        <div class="clr"></div>
                    </div>
                    <div class="master-creation right rmarg">
                        ...
                        <a style="cursor:pointer;" class="secndry import_excel_data">
                            ...
                            <span class="crtxt">Import SLAO Report</span>
                            <div class="clr"></div>
                        </a>
                        <form id="exfrm">
                ...
                <div class="filter-div">
                    ...
                    <?php if ($user_type == '2') { ?>
                        <div class="tbl-data right posrel" title="Give report feedback">
                            <div class="posabsolut act_btn_ovrly"></div>
                            <a style="cursor:pointer;" class="report_feedback" id="2" report_type="sync_data">
                ...
                <div class="scrl-tblwrap">
                    <div class="containerDiv">
                        ...
                        <div class="rowDivHeader">
                            ...
                            <div class="cellDivHeader">
                                <p>गांव का नाम</p><a style="cursor:pointer;" onclick="sort_name(2, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>बैनामे का दिनांक</p><a style="cursor:pointer;" onclick="sort_name(3, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>विलेख संख्या</p><a style="cursor:pointer;" onclick="sort_name(4, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>कास्तकार का नाम</p><a style="cursor:pointer;" onclick="sort_name(5, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>गाटा नंबर</p><a style="cursor:pointer;" onclick="sort_name(6, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>गाटा रकबा</p><a style="cursor:pointer;" onclick="sort_name(7, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>कृषक के गाटे का रकबा</p><a style="cursor:pointer;" onclick="sort_name(8, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>बैंक का नाम</p><a style="cursor:pointer;" onclick="sort_name(9, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>कृषक का बैंक खाता संख्या</p><a style="cursor:pointer;" onclick="sort_name(10, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>IFSC कोड</p><a style="cursor:pointer;" onclick="sort_name(11, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>भुगतान की धनराशि</p><a style="cursor:pointer;" onclick="sort_name(12, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
                            <div class="cellDivHeader">
                                <p>बनाया गया दिनांक</p><a style="cursor:pointer;" onclick="sort_name(13, '');"><img
                                        src="img/sorting.svg" alt="" height="24px"></a>
                            </div>
...
<script src="scripts/slao.js"></script>
<script>
                                    $(document).ready(function () {
                                        $('.full-column').on('click', '.paginate', function () {
                                            loadMoreSlaoData(parseInt($(this).text()) - 1);
                                        });
                                        $('.full-column').on('click', '.paginate_next', function () {
                                            loadMoreSlaoData(parseInt($('.current').attr('id')));
                                        });
                                        $('.full-column').on('click', '.paginate_prev', function () {
                                            loadMoreSlaoData(parseInt($('.current').attr('id')) - 2);
                                        });
                                        $('.full-column').on('click', '.paginate_last', function () {
                                            loadMoreSlaoData(parseInt($('.paginate:last').text()) - 1);
                                        });
                                    });
