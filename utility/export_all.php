...
Export_Database($mysqlHostName, $mysqlUserName, $mysqlPassword, $DbName, $tables = false, $backup_name = false, $media_export);

function Export_Database($host, $user, $pass, $name, $tables = false, $backup_name = false, $media_export) {
