...
include_once 'core/kashtkarSahmati.core.php';
?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0" style="font-weight: 600;">दी गयी सहमति</h5>
                                    <small class="text-muted float-end">
                                        <a href="kashtkarebasta" class="d-flex align-items-center justify-content-end">
                                            <i class="bx bx-plus-circle scaleX-n1-rtl bx-sm"></i>&nbsp;<span style="font-size: 1em; font-weight: 600;">नयी सहमति दें</span>
                                        </a>
                                    </small>
                                </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="text-nowrap">
                                                ...
                                                <th style="font-size: 1.1em;">अंश</th>
                                                <th style="font-size: 1.1em;">रकबा</th>
                                                <th style="font-size: 1.1em;">सहमति दिनांक</th>
                                                <th style="font-size: 1.1em;">सहमति रिपोर्ट</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($grievInfo as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $value['Ansh'] ? $value['Ansh'] : '--'; ?></td>
                                                    <td><?php echo $value['Area'] ? $value['Area'] : '--'; ?></td>
                                                    <td><?php echo date('d-m-Y g:i A', $value['DateCreated']); ?></td>
                                                    <td><a target="_blank" href="download?file=<?php echo base64_encode($value['Attachment']); ?>&type=<?php echo base64_encode('kashtkar_sahmati'); ?>">रिपोर्ट देखें</a></td>
