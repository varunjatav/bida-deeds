            ...
            <div class="full-column db-cont-wrap right">
                <div class="column-head">
                    <div class="left pageback" style="display:flex;">
                        ...
                        <div class="col-pagename left">Treasury Reports (<tCount><?php echo $total_count; ?></tCount>)
                        </div>
                        <div class="clr"></div>
                    </div>
                    <div class="master-creation right rmarg">
                        ...
                        <a style="cursor:pointer;" class="secndry import_excel_data">
                            ...
                            <span class="crtxt">Import Treasury Report</span>
                            <div class="clr"></div>
                        </a>
                        <form id="exfrm">
...
<script src="scripts/treas.js"></script>
<script>
                                    $(document).ready(function () {
                                        $('.full-column').on('click', '.paginate', function () {
                                            loadMoreTreasData(parseInt($(this).text()) - 1);
                                        });
                                        $('.full-column').on('click', '.paginate_next', function () {
                                            loadMoreTreasData(parseInt($('.current').attr('id')));
                                        });
                                        $('.full-column').on('click', '.paginate_prev', function () {
                                            loadMoreTreasData(parseInt($('.current').attr('id')) - 2);
                                        });
                                        $('.full-column').on('click', '.paginate_last', function () {
                                            loadMoreTreasData(parseInt($('.paginate:last').text()) - 1);
                                        });
                                    });
