...
<body>
    ...
    <div class="wrapper">
        <div class="col-wrapper">
            ...
            <div class="full-column db-cont-wrap right">
                <div class="column-head">
                    <div class="left pageback" style="display:flex;">
                        ...
                        <div class="col-pagename left">Lekhpal Report (<?php echo $lekhpal_name; ?>)
                        </div>
                        <div class="clr"></div>
                    </div>
                    <div class="clr"></div>
                ...
                <div class="filter-div">
                    ...
                    <div class="tbl-data right posrel" title="Export Excel">
                        ...
                        <a style="cursor:pointer;" class="export_excel_lekhpal_report_view" id="all">
                                ...
                                foreach ($villageInfo as $key => $value) {
                                    ...
                                    <div class="rowDiv <?php echo $color; ?>">
                                        <div class="cellDivCenter col1">
                                            <a style="cursor: pointer;" class="view_lekhpal_data" id="<?php echo encryptIt($value['VillageCode']); ?>"><?php echo $value['VillageName']; ?></a>
                                        </div>
            ...
            <input type="hidden" id="user_id" autocomplete="off" value="<?php echo encryptIt($lekhpal_user_id); ?>">
            <input type="hidden" id="lekhpal_name" autocomplete="off" value="<?php echo encryptIt($lekhpal_name); ?>">
            <div class="clr"></div>
